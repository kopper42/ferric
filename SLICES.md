...
Goal: Create minimal `Cargo.toml`, `src/lib.rs` with a documented public API and passing tests, plus all supporting workflow documentation and tooling so the template is immediately usable.
